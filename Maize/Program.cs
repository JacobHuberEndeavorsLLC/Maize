...
while (userResponseReadyToMoveOn == "yes" || userResponseReadyToMoveOn == "y")
{
    ...
    switch (menuAndUtility.userResponseOnUtility)
    {
        ...
        case "8":
            ...
            var minimumSet = Utils.ReadLineWarningNoNullsForceInt("What is the minimum set number?", font);
            howManyLines = Utils.CheckInputDotTxt(int.Parse(menuAndUtility.userResponseOnUtility), fileName, font);
            sw = Stopwatch.StartNew();
            Console.WriteLine();
            font.SetTextToPrimary("Gathering information...");
        ...
        case "9":
            ...
            // transfer to cob
            var done = await loopringService.CobTransferTransactionFee(
                environment,
                environmentUrl,
                environmentExchange,
                loopringApiKey,
        ...
        case "11":
            ...
            nftAmount = Utils.ReadLineWarningNoNullsForceInt("How many of each Nft do you want to transfer to each address?", font);
        ...
        case "16":
            ...
            endDatePlease = Utils.GetUnixTimeMillisecondsEnd(DateTime.Now.ToShortDateString());
        ...
        case "17":
            ...
            var userCollectionDataActual = await loopringService.GetUserNftCollection(loopringApiKey, fromAccountId);
