...
namespace Maize
{
    public class LoopringMintService : ILoopringMintService, IDisposable
    {
        ...
        public LoopringMintService(string environmentUrl, Font font)
        {
            _client = new RestClient(environmentUrl);
            _font = font;
        }
        public LoopringMintService(string environmentUrl)
        {
            _client = new RestClient(environmentUrl);
        }
        ...
        public async Task<UserCollections> FindNftCollection(string apiKey, int limit, int offset, string owner, string tokenAddress, bool verboseLogging)
        {
